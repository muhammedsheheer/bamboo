    ...
    return (
        <Button
            ...
            className={cn(
                ...
                orientation === "horizontal" ? "-left-6 top-1/2 -translate-y-1/2" : "-top-12 left-1/2 -translate-x-1/2 rotate-90",
                className
            )}
...
const CarouselNext = React.forwardRef<HTMLButtonElement, React.ComponentProps<typeof Button>>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
    ...
    return (
        <Button
            ...
            className={cn(
                "absolute h-8 w-8 rounded-full",
                orientation === "horizontal" ? "-right-16 top-1/2 -translate-y-1/2" : "-bottom-12 left-1/2 -translate-x-1/2 rotate-90",
                className
            )}
